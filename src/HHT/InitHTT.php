...
?>
	...
	<td class="Center"><input type="button" name="submit" value="<?php print get_text('CmdTruncateHTTData','HTT');?>" onClick="javascript:if(confirm('<?php print addslashes(get_text('MsgAreYouSure')); ?>')) {window.location='<?php print $_SERVER['PHP_SELF'] . '?Command=TRUNCATE'; ?>';}"></td>
	</tr>
	</table>
</form>
