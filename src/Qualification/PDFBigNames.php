...
if(!empty($_REQUEST['x_From'])) $Filter.=" and substr(QuTargetNo,2)>='".str_pad($_REQUEST['x_From'], 3, '0', STR_PAD_LEFT)."'";
if(!empty($_REQUEST['x_To'])) $Filter.=" and substr(QuTargetNo,2)<='".str_pad($_REQUEST['x_To'], 3, '0', STR_PAD_LEFT)."'";
