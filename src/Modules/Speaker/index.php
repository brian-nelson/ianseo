...
<input type="checkbox" id="useHHT" <?php echo ($enableHHT ? "checked" : "disabled");?> onClick="GetSchedule();"><?php print get_text('FollowHHT','Tournament');?><br>
...
<tbody id="tbody">
<tr id="RowDiv" class="Divider"><td colspan="7"><input type="hidden" id="lu" value="0"></td></tr>
</tbody>
</table>
