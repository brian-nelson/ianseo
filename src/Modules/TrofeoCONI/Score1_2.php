...
?>
<form name="frm" method="post" action="Score2_2.php">

	<table class="Tabella">
		<tr><th class="Title" colspan="2"><?php print get_text('MenuLM_InsertPointFirst'); ?></th></tr>
		...
		<tr>
			<th class="TitleLeft" width="15%"><?php print get_text('ManTie');?></th>
			<td>
				<select name="ManTie">
