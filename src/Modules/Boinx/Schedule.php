...
function getRss($TourId) {
	...
	// Qualifications IND (Div and Class)
	$ret.='<tr><th colspan="4">'.get_text('ResultIndClass','Tournament')."</th></tr>\n";
	...
	$ret.='</table></td>';
	$ret.='<td><table cellpadding="0" cellspacing="0" border="0" width="100%">';
	$ret.='<tr><th colspan="4">'.get_text('ResultSqClass','Tournament')."</th></tr>\n";
	// Qualifications Team (Div and Class)
	...
	$ret.='</table></td>';
	$ret.='<td><table cellpadding="0" cellspacing="0" border="0" width="100%">';
	$ret.='<tr><th colspan="4">'.get_text('IndFinal')."</th></tr>\n";
	// Finals Individual
	...
	$ret.='</table></td>';
	$ret.='<td><table cellpadding="0" cellspacing="0" border="0" width="100%">';
	$ret.='<tr><th colspan="4">'.get_text('TeamFinal')."</th></tr>\n";
	// Finals Teams
