	...
	if(count($section['items'])) {
		...
		foreach($section['items'] as $item) {
			...
			if($NeedTitle) {
				...
				$pdf->Cell(35+(12*(7-$NumPhases-$ElimCols)), 5, $section['meta']['fields']['athlete'], 1, 0, 'C', 1);
				$pdf->Cell(51, 5, $section['meta']['fields']['countryName'], 1, 0, 'C', 1);
			...
			$pdf->Cell(11, 4, $item['bib'], 'BT', 0, 'L', 0);
			$pdf->Cell(24+(12*(7-$NumPhases-$ElimCols)), 4, $item['athlete'], 'RBT', 0, 'L', 0);
			$pdf->Cell(11, 4, $item['countryCode'], 'LTB', 0, 'C', 0);
			$pdf->Cell(40, 4, $item['countryName'], 'RTB', 0, 'L', 0);
