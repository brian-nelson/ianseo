...
$LISTENERS=array(
//	'http://ianseonet.dellinux/TourGetArrows.php',
	'http://www.ianseo.net/TourGetArrows.php',
);
...
if($UpdateBase) {
	...
	/*********************
	  select countries
	**********************/
	$query = "select `CoTournament`, `CoCode`, `CoName`, `CoFlag` from `Countries`";
	...
	while($r = safe_fetch($q)) {
		...
		$quer[] = "`CoFlag`='".addslashes($r->CoFlag)."'";
