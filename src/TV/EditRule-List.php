...
<tr><td class="Center" colspan="2"><a href="<?php echo go_get('NewDb',1); ?>"><?php print get_text('NewTourContent', 'Tournament');?></a>&nbsp;&nbsp;<a href="<?php echo go_get('NewMm',1); ?>"><?php print get_text('NewMediaContent', 'Tournament');?></a></td></tr>
