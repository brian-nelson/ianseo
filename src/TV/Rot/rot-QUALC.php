...
function rotQualc($TVsettings, $RULE) {
	...
	$Return=array(
		...
		'html' => '',
		'Block' => 'QualRow',
		'BlockCss' => 'padding:0.5em; width:100%; font-size:2em; overflow:hidden; display:flex; flex-direction:row; justify-content:space-between; align-items:center; box-sizing:border-box;',
		'NextSubBlock' => 1,
		'SubBlocks' => 1);
	$ret=array();
	...
	$ret[]='<div class="Title">
		...
		'.$rankData['meta']['title'].$Title2Rows.rtrim($data['meta']['descr'], ' -)')
	.'</div>';
