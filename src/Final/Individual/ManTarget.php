...
$PAGE_TITLE=get_text('TargetFinalInd');
...
echo '<form name="Frm" method="post" action="">
    ...
    <table class="Tabella">
    <tr><th class="Title" colspan="2">'.get_text('TargetFinalInd').'</th></tr>
...
echo '<select name="d_Event" id="d_Event">';
...
echo '</select>&nbsp;<input type="submit" value="'.get_text('CmdOk').'">';
echo '&nbsp;&nbsp;&nbsp;';
    ...
    */
    ...
    // Il ciclo gestisce fino alla semifinale
        ...
        while ($CurPhase>1 && $Status==0) {
            ...
            $Select = "SELECT GrPhase,GrPosition2, GrPosition, GrMatchNo,FinEvent, FSTarget, EvTeamEvent, FsLetter
        ...
        // oro/bronzo
        $Select = "SELECT GrPhase, GrPosition2, GrPosition, GrMatchNo, FinEvent, FSTarget, FsLetter, EvTeamEvent 
        ...
        // righe di testa della fase
            ...
            for ($i=1;$i<=$HeadRows+4;++$i) {
                ...
                $MyGrid[$Row++][$Col].= '<td  class="Center" colspan="4">&nbsp;</td>';
            }
        } else {
            $Status = 1;
        }
