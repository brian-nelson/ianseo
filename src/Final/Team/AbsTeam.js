            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    unset: {
                        ...
                        action: function () {
                            document.location.href = ROOT_DIR + 'Final/Team/AbsTeam.php?EventCodes[]='+ evCode;
                        }
                    }
                },
                escapeKey: true,
...
function cancelShootOff() {
    document.location.href = ROOT_DIR + 'Final/Team/AbsTeam.php';
}
...
function goToAdvancedMode() {
    ...
    if(isAdvanced == "1") {
        document.location.href = ROOT_DIR + 'Final/Team/AbsTeam.php?Advanced=0' + events;
    } else {
        $.confirm({
            ...
            buttons: {
                ...
                unset: {
                    ...
                    btnClass: 'btn-red', // class for the button
                    action: function () {
                        document.location.href = ROOT_DIR + 'Final/Team/AbsTeam.php?Advanced=1' + events;
                    }
                }
            },
            escapeKey: true,
    ...
    $.confirm({
        ...
        buttons: {
            ...
            unset: {
                ...
                btnClass: 'btn-red', // class for the button
                action: function () {
                    document.location.href = ROOT_DIR + 'Final/Team/AbsTeam.php?RESET=' + (cntEvents*42) + events;
                }
            }
        },
        escapeKey: true,
