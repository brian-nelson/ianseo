<?php
	...
	if($d_Match and $d_Event) $ONLOAD=' onload="makeScore('.$TeamEvent.')"';
...
// combo degli eventi
	...
	// buttati in fondo per permette ad ie di eseguire il javascript nel chunk
	/*$JS_SCRIPT=array(
...
<form name="FrmParam" method="POST" action="">
	<table class="Tabella">
		...
		<tr>
			...
			if($d_Match) echo '<option value="'.$d_Match.'" selected="selected"></option>'
			?></select></td>
...
?>
<div id="idOutput"></div>
<script type="text/javascript" src="<?php print $CFG->ROOT_DIR;?>Common/Fun_JS.inc.js"></script>
<script type="text/javascript" src="<?php print $CFG->ROOT_DIR;?>Common/ajax/ObjXMLHttpRequest.js"></script>
<script type="text/javascript" src="<?php print $CFG->ROOT_DIR;?>Final/Fun_AJAX.js.php"></script>
