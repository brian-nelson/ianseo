...
<tr><td colspan="2" class="Center"><input type="button" id="Command" value="<?php print get_text('CmdSend','Tournament'); ?>" onClick="javascript:ExportAndSend('<?php print $_REQUEST['Code']?>','<?php print $CFG->DOCUMENT_PATH ;?>',<?php print $_REQUEST['Ind']; ?>,<?php print $_REQUEST['Team']; ?>);"></td></tr>
