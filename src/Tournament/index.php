...
//	$JS_TMP=substr($JS_TMP, 0, -2);
	...
	{
		$Select
			= "SELECT ToOptions,ToIocCode,ToCollation,ToId,ToType,ToCode,ToName,ToCommitee,ToComDescr,ToWhere,DATE_FORMAT(ToWhenFrom,'" . get_text('DateFmtDB') . "') AS DtFrom,DATE_FORMAT(ToWhenTo,'" . get_text('DateFmtDB') . "') AS DtTo, "
...
<?php
	if ($Arr_Values2Check_Index['d_ToWhere']['Error'])
	{
