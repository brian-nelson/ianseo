<?php
	...
	switch ($OrderCrit)
	{
		case 'ordStatus':
			...
			break;
		case 'ordTar':
			$OrderBy = "Session {$OrderDir}, TargetNo {$OrderDir} ";
			$GroupType=GROUP_TYPE_TARGET;
			break;
		case 'ordCode':
...
<form name="frm" method="post" action="">
	<table class="Tabella" id="idAthList">
		<tbody>
			<tr><th class="Title" colspan="17"><?php echo get_text('TourPartecipants','Tournament') ?></th></tr>
			<tr class="Divider"><td colspan="17"></td></tr>
			<tr><td colspan="17"><input onclick="chkAllTargets('<?php print $OrderCrit;?>','<?php print $OrderDir;?>');" type="checkbox" id="AllTargets" value="1" <?php print ($AllTargets==1 ? ' checked="checked"' : '');?>/><?php print get_text('AllTargets','Tournament');?></td></tr>
			<tr class="Divider"><td colspan="17"></td></tr>
			<tr>
				<td colspan="17"><a class="Link" href="#" onclick="add(); return false;">:<?php print get_text('CmdAdd','Tournament');?>:</a></td>
			</tr>
			<tr class="Divider"><td colspan="17"></td></tr>
<?php
print $MyHeader;
